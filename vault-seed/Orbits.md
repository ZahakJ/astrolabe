...
An **orbit** is something you come back to every day — an exercise week, the five prayers, sleep, water — with a plan for each day and a log of what you did. It is two blocks in one note: the plan, and the log the app writes under it the first time you tick something. Open the **Orbits page** (the small planet-and-ring button beside the gear, or *Open the Orbits page* in the palette) to see every orbit as today's checklist.
