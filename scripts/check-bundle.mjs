...
{ name: "entry (everyone)", keys: withLanguage(entry), budget: 759 * 1024 },
...
{ name: "anonymous blog reader", keys: withLanguage(blog), budget: 1061 * 1024 },
...
// actual, rounded up.
  ...
  { name: "admin first paint", keys: withLanguage(app), budget: 1021 * 1024 },
