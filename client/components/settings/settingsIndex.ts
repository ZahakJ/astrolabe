...
export const SETTINGS_INDEX: SettingEntry[] = [
  ...
  { tab: "publishing", label: "rowLibrary", hint: "hintLibrary" },
  { tab: "publishing", label: "rowLibraryTitle", hint: "hintLibraryTitle" },
  { tab: "publishing", label: "rowLibraryPaths", hint: "hintLibraryPaths" },
  { tab: "publishing", label: "rowLibraryNav", hint: "hintLibraryNav" },
  { tab: "publishing", label: "rowLibraryHome", hint: "hintLibraryHome" },
