...
export const SETTINGS_INDEX: SettingEntry[] = [
  ...
  { tab: "publishing", label: "rowWebmentionsAccept", hint: "hintWebmentionsAccept", mode: "instance" },
  { tab: "publishing", label: "rowWebmentionsSend", hint: "hintWebmentionsSend", mode: "instance" },
  { tab: "publishing", label: "rowFediverse", hint: "hintFediverse", mode: "instance" },
  ...
  { tab: "publishing", label: "rowReadersListen", hint: "hintReadersListen", mode: "instance" },
