...
import { GRAPH_TAB, MEDIA_TAB, ORBITS_TAB, REVIEW_WEEK_TAB, ROUTINES_TAB, TIMELINE_TAB } from "../../workspace.ts";
    ...
    <div className="s-ph-screen s-ph-more" data-screen="more">
      ...
      <div className="s-ph-scroll">
        <Group title={t("phRooms")}>
          ...
          {admin && <Item label={t("timeline")} onClick={surface(TIMELINE_TAB)} />}
