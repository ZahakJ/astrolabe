...
const DICT = {
  ...
  collectionsFull: { en: "No room: {max} collections already", ar: "لا مكان: {max} مجموعة بالفعل" },
  collectionPopOn: { en: "A collection: “{title}”", ar: "مجموعة: “{title}”" },
  collectionPopOpen: { en: "Open on the site", ar: "افتح على الموقع" },
  collectionPopStop: { en: "Unlink the folder", ar: "فك ربط المجلد" },
  collectionPopHint: { en: "Every published note inside joins it; frontmatter can add notes from elsewhere.", ar: "كل ملاحظة منشورة بداخله تنضم إليها، ويمكن للترويسة إضافة ملاحظات من أماكن أخرى." },
  collectionPopMake: { en: "Make it a collection", ar: "اجعله مجموعة" },
