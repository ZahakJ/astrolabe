...
const DICT = {
  ...
  // ── Routines: the daily tracker (shared/routine.ts, client/reading/routine.ts, client/routines/) ──
  routines: { en: "Routines", ar: "الروتين" },
  routinesTitle: { en: "Open the Routines page", ar: "فتح صفحة الروتين" },
  cmdOpenRoutines: { en: "Open the Routines page", ar: "فتح صفحة الروتين" },
  ...
  routinesAdd: { en: "New routine", ar: "روتين جديد" },
  routinesEmpty: { en: "No routines yet.", ar: "لا روتين بعد." },
  routinesEmptyHint: { en: "Start from a template — an exercise week, prayers, sleep, water — or draw up your own.", ar: "ابدأ من قالب: أسبوع تمارين، الصلوات، النوم، الماء، أو ارسم روتينك بنفسك." },
  routinesFailed: { en: "The routines could not be loaded.", ar: "تعذّر تحميل الروتين." },
  ...
  routinesAdded: { en: "“{title}” added to your routines", ar: "أُضيف «{title}» إلى روتينك" },
  ...
  routinesBlank: { en: "Blank", ar: "فارغ" },
  ...
  routineFormNew: { en: "New routine", ar: "روتين جديد" },
  routineFormEdit: { en: "Edit “{title}”", ar: "تعديل «{title}»" },
  routineFormTitle: { en: "Title", ar: "العنوان" },
  routineFormTitlePlaceholder: { en: "Weekly exercise", ar: "تمارين الأسبوع" },
  routineFormKind: { en: "Kind", ar: "النوع" },
  routineFormKindOwn: { en: "Your own word", ar: "كلمتك" },
  routineFormSlots: { en: "Columns of the week", ar: "أعمدة الأسبوع" },
  routineFormSlotsHint: { en: "The parts of a day you plan by — morning, evening — separated by commas. Leave empty for one line per day.", ar: "أجزاء اليوم التي تخطط بها: صباحًا، مساءً، مفصولة بفواصل. اتركه فارغًا لسطر واحد لكل يوم." },
  routineFormItems: { en: "Every day", ar: "كل يوم" },
  routineFormItemsHint: { en: "Things asked of every day, separated by commas: Fajr, 8 glasses, read 20 pages.", ar: "ما يُطلب كل يوم، مفصولًا بفواصل: الفجر، 8 أكواب، قراءة 20 صفحة." },
  routineFormWeek: { en: "The week", ar: "الأسبوع" },
  routineFormWeekHint: { en: "A plan per weekday. Leave a day empty and it is a rest day.", ar: "خطة لكل يوم من الأسبوع. اترك يومًا فارغًا فيكون يوم راحة." },
  routineFormFields: { en: "Numbers to keep", ar: "أرقام تحفظها" },
  routineFormFieldsHint: { en: "One per line as name:type — minutes:number, weight:number:kg, mood:scale:5, soreness:text, stretched:check.", ar: "واحد في كل سطر بصيغة اسم:نوع — دقائق:number، الوزن:number:كغ، المزاج:scale:5، ألم:text، إطالة:check." },
  ...
  routineKindOwn: { en: "Routine", ar: "روتين" },
  routineUntitled: { en: "Untitled routine", ar: "روتين بلا عنوان" },
  ...
  slashRoutine: { en: "Routine", ar: "روتين" },
