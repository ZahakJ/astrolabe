...
const DICT = {
  ...
  libraryMenu: { en: "Library…", ar: "المكتبة…" },
  ...
  hintLibraryPaths: { en: "Each row is a folder of the vault. Only its published notes appear.", ar: "كل صف مجلد من الخزانة. لا تظهر منه إلا الملاحظات المنشورة." },
  ...
  libraryPathSlug: { en: "Address", ar: "العنوان الشبكي" },
  ...
  errLibraryMax: { en: "At most {max} paths.", ar: "{max} مسارات على الأكثر." },
