...
const DICT = {
  ...
  periodicSection: { en: "Daily & weekly notes", ar: "الملاحظات اليومية والأسبوعية" },
  dailyFolderLabel: { en: "Daily notes folder", ar: "مجلد الملاحظات اليومية" },
  dailyFolderHint: { en: "Where Ctrl/Cmd Alt D files the day. Empty for the vault root.", ar: "حيث يودع Ctrl/Cmd Alt D اليوم. فارغ لجذر الخزانة." },
  dailyFormatLabel: { en: "Daily note name", ar: "اسم الملاحظة اليومية" },
  dailyFormatHint: { en: "YYYY, MM, DD, [literals] and / for subfolders — YYYY/YYYY-MM-DD files by year. Always Gregorian: a file name is an address.", ar: "YYYY وMM وDD و[نص] و/ للمجلدات الفرعية؛ YYYY/YYYY-MM-DD يودع حسب السنة. ميلادي دائمًا: اسم الملف عنوان." },
  dailyTemplateLabel: { en: "Daily note template", ar: "قالب الملاحظة اليومية" },
  dailyTemplateHint: { en: "Applied when a day's note is created. Empty: the template for new notes.", ar: "يُطبَّق عند إنشاء ملاحظة اليوم. فارغ: قالب الملاحظات الجديدة." },
