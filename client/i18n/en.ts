...
const en = {
  ...
  // Settings → Your own voices' Browse… in the desktop app.
  dlgChooseVoices: "Choose your voices folder",
  dlgChooseVoicesButton: "Use this folder",
  ...
  voiceCostCpu: "{size}; a minute of speech in about {secs} s on two cores",
  voiceBackendLabel: "Where it runs",
  voiceBackendAuto: "Auto",
  voiceBackendCpuOnly: "Processor only",
  voiceBackendGpu: "the GPU",
  ...
  voiceNoteRanOn: "Downloaded; {model} last ran on {backend}.",
  voiceNoteRunsOn: "Downloaded; {model} runs on {backend}.",
  ...
  cmdReadNote: "Read this note aloud",
  cmdReadNoteHint: "From the caret, a sentence at a time, lit as it is read",
  cmdOwnVoices: "Your own voices…",
  cmdOwnVoicesHint: "Point Read aloud at a folder of Piper voices already on this computer",
  speakNothingSelected: "Select some words to read aloud first.",
  // The floating player.
  speakPlayer: "Read aloud",
  speakPlay: "Play",
  speakPause: "Pause",
  speakReplay: "From the start",
  speakStop: "Stop",
  speakRate: "Speed",
  ...
  speakEngineNaturalNote: "a recent processor",
  speakStatusNone: "Not installed yet; until then this device's own voices read, and say so.",
  speakStatusReady: "{engine} voices installed ({size}), running on the processor.",
  ...
  // The per-language voice pickers (Settings and the player's ▾): the
  // built-in engine's voices, then the reader's own from the voices folder.
  speakVoiceFor: "Voice for {language}",
  speakVoiceDefault: "{name} (default)",
  speakVoiceAuto: "Automatic",
  speakVoicesBuiltIn: "Built in",
  speakVoicesYours: "Your voices",
  ...
  ownEmpty: "No folder yet. Point this at the folder your Piper voices live in: where LibreOffice's Read Text keeps them, or wherever you downloaded them.",
  ownNoneFound: "No voices found in this folder",
  ownSkipped: "{count} skipped: {why}",
  ownOtherLanguages: "also voices in languages Read aloud does not speak yet: {languages}",
  ownSkippedShow: "Which files, and why",
  ownTruncated: "the folder is very large, so the scan stopped early; choose the voices folder itself",
  ownSkipNoJson: "no .json beside the model",
  ownSkipNoModel: "a .onnx.json with no model beside it",
  ownSkipBadJson: "its config is not a Piper voice's",
  ownSkipNoLanguage: "its config names no language",
  ownSkipOtherLanguage: "in {languages}, which Read aloud does not speak yet",
  ownSkipUnreadable: "the server cannot read it",
  ownSkipNoKokoroModel: "a Kokoro voices file with no kokoro-*.onnx beside it",
  ownNeedsLight: "Your Piper voices run on the Light engine. Installing Light downloads its own built-in voices once ({size}); your voice files are not downloaded again.",
  ownNeedsNatural: "Your Kokoro voices run on the Natural engine. Installing Natural downloads its own model once ({size}); your voice files are not downloaded again.",
  ownMoreVoices: "Get more voices:",
  ownCatalogue: "the Piper voices catalogue",
  ownExternalHead: "An external speaker (advanced)",
  ...
  errVoicesDirNotDir: "That path is a file, not a folder.",
  errVoicesDirUnreadable: "The server cannot read that folder: its user has no permission.",
  errExternalNoOut: "The command must name {out}, the file it writes the sound to.",
  errExternalQuotes: "The command's quotes do not close.",
  errExternalNoLangs: "Choose at least one language for the external speaker.",
  speakRateSlow: "Slower",
  speakRateNormal: "Normal",
  speakRateFast: "Faster",
  // Settings → Publishing.
