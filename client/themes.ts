...
const COUNTERPART: Record<Theme, Theme> = {
  ...
  "monokai": "github-light",
  "material-ocean": "github-light",
...
export const THEME_LABELS: Record<Theme, { name: I18nKey; desc: I18nKey }> = {
  "github-dark": { name: "thGithubDark", desc: "thGithubDarkDesc" },
  "nord": { name: "thNord", desc: "thNordDesc" },
  "dracula": { name: "thDracula", desc: "thDraculaDesc" },
  "one-dark": { name: "thOneDark", desc: "thOneDarkDesc" },
  "tokyo-night": { name: "thTokyoNight", desc: "thTokyoNightDesc" },
  "catppuccin-mocha": { name: "thCatppuccinMocha", desc: "thCatppuccinMochaDesc" },
  "gruvbox-dark": { name: "thGruvboxDark", desc: "thGruvboxDarkDesc" },
  "solarized-dark": { name: "thSolarizedDark", desc: "thSolarizedDarkDesc" },
  "monokai": { name: "thMonokai", desc: "thMonokaiDesc" },
  "material-ocean": { name: "thMaterialOcean", desc: "thMaterialOceanDesc" },
  "palenight": { name: "thPalenight", desc: "thPalenightDesc" },
  "ayu-dark": { name: "thAyuDark", desc: "thAyuDarkDesc" },
  "ayu-mirage": { name: "thAyuMirage", desc: "thAyuMirageDesc" },
  "everforest-dark": { name: "thEverforestDark", desc: "thEverforestDarkDesc" },
  "rose-pine": { name: "thRosePine", desc: "thRosePineDesc" },
  "night-owl": { name: "thNightOwl", desc: "thNightOwlDesc" },
  "kanagawa": { name: "thKanagawa", desc: "thKanagawaDesc" },
  "github-light": { name: "thGithubLight", desc: "thGithubLightDesc" },
  "catppuccin-latte": { name: "thCatppuccinLatte", desc: "thCatppuccinLatteDesc" },
  "solarized-light": { name: "thSolarizedLight", desc: "thSolarizedLightDesc" },
  "gruvbox-light": { name: "thGruvboxLight", desc: "thGruvboxLightDesc" },
  "ayu-light": { name: "thAyuLight", desc: "thAyuLightDesc" },
  "everforest-light": { name: "thEverforestLight", desc: "thEverforestLightDesc" },
  "rose-pine-dawn": { name: "thRosePineDawn", desc: "thRosePineDawnDesc" },
  ...
  graphite: { name: "thGraphite", desc: "thGraphiteDesc" },
