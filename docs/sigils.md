...
**The month is not here.** It was, from 3.17 until 3.18, as a card under the heading. This page
answers *what do I keep every day, and did I keep it today*; a month answers *which day*, which is
a different errand — and it pushed the checklists down the screen to ask it. The month is a page of
its own now: [the Calendar](templates-and-notes.md#the-calendar), the door beside this one in the
top bar.
