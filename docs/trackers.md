...
| `pace` | a number | Units a day you mean to move — `pace: 20`. With a total, the card says the day you will be done. An [orbit](routines.md) that names this work reads the day's pages from it. |
