...
وفي كل خانة تؤكّد أن الشريط الجانبي عمود شبكة حقيقي (غير مُودَع تلقائيًا، وليس طبقة عائمة) حيثما استطاع مؤشّر أن يصيب شريطًا، وأن لكل لوحة مرسّاة مقبضًا مساحةُ إصابته 12 بكسل **متمركزة على فاصل اللوحة نفسه ذي البكسل الواحد**؛ فـ`elementFromPoint` عند الدرز يجب أن يعيد المقبض، وأن عمود الملاحظة لا يهبط أبدًا تحت أرضيته البالغة 320 بكسل مهما كان المخزون، وألّا تخرج أي لوحة ولا زر إغلاق أي لوحة عن النافذة، وألّا تنزلق الصفحة أفقيًا أبدًا. تحتاج نسخةً تعمل، و`CHROMIUM`، وكلمة سر النسخة وسيطًا ثانيًا.
