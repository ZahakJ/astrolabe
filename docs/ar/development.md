...
**الأشكال الأربعة.** `phone` جهاز Pixel 7 بمقاس 412×915 بإصبع. و`stylus` مقاس 720×820 بكثافة 1.5 مع قلم — `availablePointerTypes=6, primaryPointerType=2, availableHoverTypes=3, primaryHoverType=1` — وهو إعداد Blink في متصفح مستقل، لأن `hasTouch` يجعل كروميوم يبلّغ عن جهاز خشن فقط مهما قالت رايات المؤشر؛ وهو الوضع الذي قُدّم له هيكل سطح المكتب يومًا. و`tablet` و`tablet-land` لوح لمس بمقاس 820×1180 و1180×820، يرسم فيه الهيكل عموده وقائمته والملاحظة، وتنزلق ورقة الملاحظة من الجانب.
