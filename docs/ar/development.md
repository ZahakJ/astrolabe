...
**ومنذ 3.25.0 يجري السُّلّم في تخطيط الهاتف الكلاسيكي**، لأن خلايا الدرج فيه تقيس هيكل الدرج؛ وتمشي درجة أخيرة، `whichShell`، بكل وضع عبر العروض تحت التخطيط الافتراضي، وتؤكد هيكل الهاتف تحت 700 وعلى اللوح بكل عرض، وهيكل سطح المكتب — كما هو بلا تغيير — في كل ما عدا ذلك.
