...
فالبوابة تجلب خزانتها. يولّد `scripts/perf-fixture.mjs` خزانةً من بذرة ثابتة: 2000 ملاحظة في 40 مجلدًا بمقدّمات وروابط ويكي ووسوم، وملاحظةٌ من 3000 سطر، وملاحظةٌ فيها خمسون تضمينًا، وسنةٌ من الملاحظات اليومية، و(على الجهاز الذي فيها عنده) ملف PDF من 665 صفحة وملاحظات الطلاسم والمدارات الحقيقية. ثم يشغّل `check-perf` خادمه الخاص فوقها، على منفذه الخاص، في الوضع المحلي المفتوح. **ولا يأخذ مسار خزانة قط**، فلا يمكن توجيهه إلى خزانتك.
...
- **2000 ملاحظة** في 40 مجلدًا، لكل واحدة ستّ خصائص في المقدّمة وخمسة `[[روابط ويكي]]` وثلاثة `#وسوم`: أي 121 وسمًا متمايزًا في شجرة، و2000 عقدة للمخطط؛
...
- ملف **PDF من 665 صفحة** للمالك نفسه وملاحظات **الطلاسم** و**المدارات** الحقيقية، حين تكون على الجهاز؛ والخزانة خزانةٌ من دونها، والبوابة تقول ذلك بدل أن تخترع كتابًا.
