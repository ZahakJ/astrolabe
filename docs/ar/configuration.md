...
- **الخزانة**: أين تكتب هذه النسخة الأشياء: مجلد القوالب وقالب الملاحظات الجديدة، و[الملاحظات الدورية](templates-and-notes.md#الملاحظات-الدورية) (صف واحد: المجلد الذي تتقاسمه الأنواع الأربعة، واسم وقالب لكل من اليوم والأسبوع والشهر والسنة)، ومجلد الرسوم، و**افتح عند التشغيل** (على ماذا يفتح التطبيق: حيث توقفت، أو صفحة السِّجِلّ، أو رفّ المدارات، أو ملاحظة اليوم، أو ملاحظة تختارها؛ فوق الجلسة المستعادة، ولا يعلو أبدًا على رابط ملصوق)، و**أين تُكتب المرفقات الجديدة** (انظر [المرفقات](#attachments))، ومجلد الوسوم، وإصدارات الملاحظات، والبحث في PDF.
