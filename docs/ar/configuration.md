...
- **الطباعة**: أربعة مواضع للخطوط (خط النص، وخط الواجهة، وخط الكود، وخط الحرف العربي)، تختار كلًّا منها من كتالوج يستضيفه الخادم نفسه *أو* من ملفات خطوط ترفعها بنفسك، مع عيّنة حيّة تبقى على الشاشة وأنت تختار. انظر [الخطوط](typography.md).
