...
- **الخزانة**: أين تكتب هذه النسخة الأشياء: مجلد القوالب وقالب الملاحظات الجديدة، والملاحظات اليومية والأسبوعية، ومجلد الملاحظة الفريدة واسمها، ومجلد الرسوم، و**أين تُكتب المرفقات الجديدة** (انظر [المرفقات](#attachments))، ومجلد الوسوم، وإصدارات الملاحظات، والبحث في PDF.
...
| `uniqueFolder` | مجلد نسبي إلى الخزانة يودع فيه أمر *ملاحظة فريدة جديدة* ملاحظاته (انظر [الملاحظات الفريدة](templates-and-notes.md#unique-notes)) | لا شيء — جذر الخزانة |
