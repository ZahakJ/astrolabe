...
- **بطاقات PDF والمرفقات.** `![[file.pdf]]` (وكذلك mp4 وzip وغيرها) يصير بطاقة تفتح الملف في تبويب جديد.
- **صفحة من كتاب.** `![[Book.pdf#page=42]]` يرسم تلك الصفحة صورةً في موضع التضمين — في المحرر (عنصر نائب بشكل الورقة حتى تُرسم)، وفي عرض القراءة، وعلى موقعك حين يكون الكتاب منشورًا — وتحتها «Book، ص 42». انقر التعليق لتفتح [القارئ](books.md) على تلك الصفحة؛ ونقرة الزائر تفتح الملف عندها. و`|300` يحدّد العرض كما في الصور.
- **الصوت.** `![[lecture.mp3]]` (وكذلك ogg وm4a وwav) مشغّل صغير بدل بطاقة الملف، حيثما تُقرأ الملاحظة. و`[[lecture.mp3#t=1:23]]` رابط إلى لحظة: النقر عليه ينقل المشغّل في الصفحة نفسها إلى 1:23 ويشغّله، أو يفتح الملف عند تلك اللحظة إن لم يكن في الصفحة مشغّل. تعمل `t=83` و`t=1:23` و`t=1:02:03` كلها؛ أعطه اسمًا بديلًا (`|الحجة`) وإلا أظهر الوقت.
