...
التضمين يضع ملفًا داخل ملاحظة: الصورة نفسها، أو بطاقةً لملف PDF أو zip، أو صفحةً واحدة من كتاب، أو مشغّلًا لتسجيل، أو رسمة، أو ملاحظة أخرى. الصق ملفًا في المحرر أو أسقطه فيه فيُكتب التضمين عنك (ويُرفع الملف إلى [مجلد المرفقات](configuration.md#المرفقات))؛ ولتكتبه بيدك اكتب `/embed` لترى الصيغ الثلاث، أو `![[` واختر الملف — تنفتح القائمة على ملفات خزانتك والصيغ فوقها. و**تضمين ملف…** في لوحة الأوامر يفعل الشيء نفسه من لوحة المفاتيح.
...
| `![[lecture.mp3]]` | مشغّل صغير (وكذلك ogg وm4a وwav وwebm). |
| `![[clip.mp4]]` و`![[bundle.zip]]` | بطاقة للملف (الفيديو وzip وcsv وtxt وسائرها). |
