...
وثمّة إعدادان يستطيعان *تضييق* ما يراه الزوار أكثر، من غير إلغاء نشر أي شيء: [`EXCLUDE_TAGS`](configuration.md#environment-variables) يخفي وسومًا معيّنة من قوائم المواضيع العامة، و[مرشّح اللغة](arabic-and-rtl.md#language-filter) يخفي الملاحظات غير المكتوبة باللغة المختارة. وكلاهما ترتيب للواجهة لا أكثر. أما `publish: false` فهو المفتاح الذي يغلق الباب فعلًا.
