...
shelf and remembers it. This is the only month the app draws: the [Sigils page](sigils.md#the-sigils-page)
drew a second copy of it until 3.18, off the same reads, and the page is the day's checklists
now. A visitor to the public site sees
