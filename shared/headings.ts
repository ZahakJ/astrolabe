 ...
 *  title (what the reading view shows), by its slug id (what the `[[Note#`
 *  completion offers — client/editor/autocomplete.ts lists the anchor table's
 *  ids — and what the reading view's elements carry), or by its raw source
 *  (what a link typed before the two agreed may still say). First match wins, as the anchor
