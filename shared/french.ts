...
// ── Is this line French? ────────────────────────────────────────────────────
// In shared/frenchLine.ts (first-paint code); re-exported here.
export { frenchScore, looksFrench, noteIsFrench } from "./frenchLine.ts";
import { TOKEN_RE, looksFrench } from "./frenchLine.ts";
