...
- **Unreleased** — webmentions and the fediverse: mentions received into moderation and sent on publish, the blog as one ActivityPub account, all behind three switches that start off and one rule for what may leave ([public-site.md](public-site.md), [vault-server.md](vault-server.md)).
