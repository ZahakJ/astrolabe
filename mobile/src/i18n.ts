...
const en = {
  ...
  refuseAttachmentRename: "Renaming a file rewrites every note that embeds it, from the index a server keeps; the pocket does not keep that index.",
  ...
  refuseSpeaker: "The Read aloud voices run on an Astrolabe server's own machine; a pocket vault reads with this phone's voices.",
  ...
  keepExternalVideo: "Embedding external video is a switch in the Publishing tab, which a pocket vault has not got.",
...
const ar: Copy = {
  ...
  refuseAttachmentRename: "إعادة تسمية ملف تعيد كتابة كل ملاحظة تضمّنه اعتمادًا على فهرس يحتفظ به الخادم؛ ولا يحتفظ الجيب بذلك الفهرس.",
  ...
  refuseSpeaker: "أصوات القراءة بصوت عالٍ تعمل على جهاز خادم أسطرلاب نفسه؛ والخزانة في الجيب تقرأ بأصوات هذا الهاتف.",
  ...
  keepExternalVideo: "تضمين الفيديو الخارجي مفتاحٌ في لوحة النشر، والخزانة في الجيب لا لوحة نشر لها.",
